...
Feature: Stanford postcard bean Type
  ...
  Scenario: Create stanford postcard block
    ...
    Then I attach the file "features/stanford_bean_types/img/ooooaaaahhh.jpg" to "edit-field-s-image-info-und-0-field-s-image-image-und-0-upload"
    ...
    Then I attach the file "features/stanford_bean_types/img/ooooaaaahhh.jpg" to "files[field_s_postcard_image_insert_und_0]"
