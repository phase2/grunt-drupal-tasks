Feature: Ensure items on the MSE landing page appear as expected
  In order to ensure items on the MSE landing page appear as expected
  As a Site User
  I want to be able to view all the MSE landing page blocks in their appropriate regions
  ...
  Scenario: Verify users can view the WYSIWYG text
    ...
    Then I should see the text "With its roots"

  @safe
  Scenario: Verify users can view the first postcard linked block
    Then I should see a "a" element in the "Content Lower" region
    Then I should see a "#block-bean-mse-what-are-we-researching-bloc" element
    Then I should see a "#block-bean-mse-what-are-we-researching-bloc.span12.next-row.well.no-margin.no-padding" element
  ...
  Scenario: Verify users can view the second postcard linked block
    Then I should see a "a" element in the "Content Lower" region
    Then I should see a "#block-bean-mse-what-is-it-like-for-undergra" element
    Then I should see a "#block-bean-mse-what-is-it-like-for-undergra.span12.next-row.well.no-margin.no-padding" element

  @safe
  Scenario: Verify users can view the third postcard linked block
    Then I should see a "a" element in the "Content Lower" region
    Then I should see a "#block-bean-mse-what-is-it-like-for-graduate" element
    Then I should see a "#block-bean-mse-what-is-it-like-for-graduate.span12.next-row.well.no-margin.no-padding" element

  @safe
  Scenario: Verify users can view the Information For block
    Then I should see a "a" element in the "Content Lower" region
    Then I should see a "#block-bean-mse-information-for" element
    Then I should see a "#block-bean-mse-information-for.span6.next-row.well" element
