Feature: Ensure items on the BioE landing page appear as expected
  In order to ensure items on the BioE landing page appear as expected
  As a Site User
  I want to be able to view all the BioE landing page blocks in their appropriate regions
  ...
  Scenario: Verify users can view the WYSIWYG text
    ...
    Then I should see the text "The bioengineering"

  @safe
  Scenario: Verify users can view the first postcard linked block
    Then I should see a "a" element in the "Content Lower" region
    Then I should see a "#block-bean-bioengineering-what-are-we-resea" element
    Then I should see a "#block-bean-bioengineering-what-are-we-resea.span12.well.no-margin.no-padding" element
  ...
  Scenario: Verify users can view the second postcard linked block
    Then I should see a "a" element in the "Content Lower" region
    Then I should see a "#block-bean-bioengineering-undergraduate-stu" element
    Then I should see a "#block-bean-bioengineering-undergraduate-stu.span12.next-row.well.no-margin.no-padding" element

  @safe
  Scenario: Verify users can view the third postcard linked block
    Then I should see a "a" element in the "Content Lower" region
    Then I should see a "#block-bean-bioengineering-graduate-students" element
    Then I should see a "#block-bean-bioengineering-graduate-students.span12.next-row.well.no-margin.no-padding" element
  ...
  Scenario: Verify users can view the Research Themes block
    ...
    Then I should see a "#block-bean-bioengineering-information-for.span6.next-row.well" element
